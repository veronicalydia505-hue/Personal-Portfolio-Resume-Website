...
<section id="home" class="hero">
    <div class="container">
        <div class="profile-container">
           <!-- FIXED: use a correct relative path and valid class attribute -->
           <img src="profilepic.png" alt="Nurul Hidayu" class="profile-pic">
        </div>
        <h1>Nurul Hidayu</h1>
        <h2>Multimedia Computing Student & UI/UX Designer</h2>
        <p>Third-year Bachelor of Multimedia Computing student at Universiti Malaysia Sarawak (UNIMAS), skilled in Java, Python, HTML/CSS, and UI/UX design. A motivated, fast-learning, and creati[...]
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text fade-in">
                    <h3>My Expertise</h3>
                    <p>A motivated, fast-learning, and creative individual with strong teamwork and communication skills. Seeking an internship opportunity to apply technical and design expertise[...]
